      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start">
        ...
        >
          ...
          <div className="flex space-x-6 text-2xl">
            <a href="https://github.com/AdityaMISHRA2803" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 text-gray-700 dark:text-gray-300">
              <FaGithub />
            </a>
            <a href="http://linkedin.com/in/aditya-mishra-iiit/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 text-gray-700 dark:text-gray-300">
              <FaLinkedin />
            </a>
            <a href="mailto:aditya.iiitsp@gmail.com" className="hover:text-blue-600 text-gray-700 dark:text-gray-300">
              <FaEnvelope />
            </a>
          </div>

          <a
            href="/Aditya-Mishra-Resume.pdf"
            download
