  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center text-center px-4 pt-28 pb-12 max-w-4xl mx-auto">
        ...
        >
          Hi, I'm <span className="text-blue-500">Aditya Mishra</span>
        </motion.h1>
...
>
  ...
  />
        ...
        >
          Results-driven full-stack developer with MERN expertise, C++, JavaScript & SQL. Passionate about building scalable web apps, APIs, and cloud-native solutions.
        </motion.p>
        ...
        >
          <a
            href="mailto:aditya.iiitsp@gmail.com"
          ...
          <a
            href="https://github.com/AdityaMISHRA2803"
            target="_blank"
          ...
          <a
            href="https://linkedin.com/in/aditya-mishra-iiit/"
            target="_blank"
            rel="noopener noreferrer"
